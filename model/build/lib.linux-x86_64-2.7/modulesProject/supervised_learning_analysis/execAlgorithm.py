...
class execAlgorithm(object):
    ...
    def execAlgorithmByOptions(self):
        ...
        if self.algorithm == 1:#Adaboost
            ...
            try:
                #curva roc
                curveRocObject = createRocCurve.curveRoc(self.data, self.target, AdaBoostObject.model, self.validation, self.user, self.job, self.pathResponse)
            ...
            try:
                ...
                precisionCurve = createPrecisionRecallCurve.curvePrecision(self.data, self.target, AdaBoostObject.model, self.validation, self.user, self.job, self.pathResponse)
