$(document).ready(function() {
    ...
    $('#algorithm').change(function(){
				...
				if($('#algorithm').val() == 9) {//SVC
					...
					$('#GradientBoostingClassifier5').hide();
				...
				if($('#algorithm').val() == 1) {//AdaBoostClassifier
				...
				if($('#algorithm').val() == 3) {//DecisionTree
            $('#DecisionTree1').show();
						$('#DecisionTree2').show();
            ...
            $('#GradientBoostingClassifier1').show();
						...
						$('#GradientBoostingClassifier5').show();
						//oculto el resto
						$('#DecisionTree1').hide();
						$('#DecisionTree2').hide();
						$('#BaggingClassifier1').hide();
				...
				if($('#algorithm').val() == 8) {//RandomForestClassifier
	...
	$('#initNewJob').bootstrapValidator({
      ...
      var algorithm = $("#initNewJob #algorithm").val();
			...
			if (algorithm == 1){//AdaBoostClassifier

				var AdaBoost_n_estimators = $("#initNewJob #AdaBoost_n_estimators").val();
				var AdaBoost_loss = $("#initNewJob #AdaBoost_loss").val();

				//evaluamos los valores por defecto...
				if (AdaBoost_loss == "Default"){
				...
				$.ajax({
					method: "POST",
					url: "../php/prediction/execAdaBoost.php",
					data: {
						"nameJob"   : nameJob,
						"descJob"   : descJob,
	          "algorithm"   : algorithm,
						"AdaBoost_n_estimators" : AdaBoost_n_estimators,
						"AdaBoost_loss" : AdaBoost_loss
					}
				}).done( function( info ){
			...
			if (algorithm == 2){//Bagging
				...
				$.ajax({
					method: "POST",
					url: "../php/prediction/execBagging.php",
					data: {
						"nameJob"   : nameJob,
						"descJob"   : descJob,
	          "algorithm"   : algorithm,
			...
			if (algorithm == 3){//DecisionTree
				...
				if (DecisionTree_criterion == "default"){
					DecisionTree_criterion = "mse";
				}

				//hacemos la llamada por ajax para ejecutar el algoritmo...
				$.ajax({
					method: "POST",
					url: "../php/prediction/execDecisionTree.php",
					data: {
						"nameJob"   : nameJob,
						"descJob"   : descJob,
	          "algorithm"   : algorithm,
			...
			if (algorithm == 4){//Gradient
				...
				var gradient_criterion = $("#initNewJob #gradient_criterion").val();
				...
				//evaluamos los valores por defecto...
				if (gradient_criterion == "Default"){
					gradient_criterion = "friedman_mse";
				}
				...
				$.ajax({
					method: "POST",
					url: "../php/prediction/execGradient.php",
					data: {
						"nameJob"   : nameJob,
						"descJob"   : descJob,
	          "algorithm"   : algorithm,
						"gradient_loss" : gradient_loss,
						"gradient_criterion" : gradient_criterion,
			...
			if (algorithm == 5){//KNN
				...
				$.ajax({
					method: "POST",
					url: "../php/prediction/execKNN.php",
					data: {
						"nameJob"   : nameJob,
						"descJob"   : descJob,
	          "algorithm"   : algorithm,
			...
			if (algorithm == 6){//MLP
				...
				$.ajax({
					method: "POST",
					url: "../php/prediction/execMLP.php",
					data: {
						"nameJob"   : nameJob,
						"descJob"   : descJob,
	          "algorithm"   : algorithm,
			...
			if (algorithm == 7){//NuSVC
				...
				$.ajax({
					method: "POST",
					url: "../php/prediction/execNuSVC.php",
					data: {
						"nameJob"   : nameJob,
						"descJob"   : descJob,
						"algorithm"   : algorithm,
			...
			if (algorithm == 8){//RandomForestClassifier
				...
				$.ajax({
					method: "POST",
					url: "../php/prediction/execRandomForest.php",
					data: {
						"nameJob"   : nameJob,
						"descJob"   : descJob,
						"algorithm"   : algorithm,
			...
			if (algorithm == 9){//SVC
				...
				$.ajax({
					method: "POST",
					url: "../php/prediction/execSVC.php",
					data: {
						"nameJob"   : nameJob,
						"descJob"   : descJob,
						"algorithm"   : algorithm,
