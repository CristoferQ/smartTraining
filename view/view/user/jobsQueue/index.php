...
<head>
    ...
    <script src="../js/jobsQueue/loadJobsByStage.js"></script>
    <script src="../js/jobsQueue/loadJobsStageByDate.js"></script>
    <script src="../js/jobsQueue/loadTable.js"></script>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">My Jobs Queue Exec</h1>
              ...
              <div id="page-content">
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Jobs Queue by Status</h3>
                        </div>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Use queue System</h3>
                        </div>
                        <div class="panel-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12" id="processing" style="display:none;">
                    <div class="alert alert-warning" role="alert">
                      This job is in PROCESS status, It will notify by email when change status of job.
                    </div>
                  </div>

                  <div class="col-sm-12 col-md-12 col-lg-12" id="init" style="display:none;">
                    <div class="alert alert-success" role="alert">
                      This job is in INIT status, It will notify by email when change status of job
                    </div>
                  </div>
                    ...
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                          ...
                          <div id="demo-custom-toolbar2" class="table-toolbar-left">
                              <button id="demo-dt-addrow-btn" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="demo-pli-plus"></i> Add new Job</button>
                          </div>
