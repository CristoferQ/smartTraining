...
<head>
    ...
    <script src="../js/clustering/loadResponse.js"></script>
</head>
                            ...
                            <div class="panel-body">
                              <table class="table table-hover table-vcenter">
                                ...
                                <tr>
                                  ...
                                  <tr>
                                      <td>
                                        <span class="text-main text-semibold">Calinski harabaz score</span>
                                      </td>
					                            <td>
                                  ...
                                  <tr>
                                      <td>
                                        <span class="text-main text-semibold">Silhouette Coefficient score</span>
                                      </td>
					                            <td>
                                  ...
                                  <tr>
                                      <td>
                                        <span class="text-main text-semibold">Params Algorithm</span>
                                      </td>
					                            <td>
                                  ...
                                  <tr>
                                      <td>
                                        <span class="text-main text-semibold">Number Groups</span>
                                      </td>
					                            <td>
                                  ...
                                  <tr>
                                      <td>
                                        <span class="text-main text-semibold">Download File</span>
                                      </td>
					                            <td>
					                                <span class="text-main text-semibold">
                                            <?php
                                              echo "<a href=../../../dataStorage/".$_GET['user']."/".$_GET['job']."/responseClustering.csv>responseClustering.csv</a>";
                                            ?>
                                          </span>
					                                <br>
					                            </td>
