...
<head>
    ...
    <script src="../js/characteristic/createJob.js"></script>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Characteristic Analysis Process</h1>
                  ...
                  <div class="col-sm-12 col-md-12">
                    ...
                    <div class="panel">
                      ...
                      <div class="panel-body">
                        <form id="frmAgregarFile" action="../php/uploadFileCharacteristic.php" class="dropzone" >
