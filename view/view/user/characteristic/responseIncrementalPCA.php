...
<head>
    ...
    <script src="../js/characteristic/processViewPCAIncremental.js"></script>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Explanation variance by components</h3>
                        </div>
                        ...
                        <div class="panel-body">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <span class="text-main text-semibold">Incremental PCA</span>
                                <br>
                              </td>
                             </tr>
                                  ...
                                  <td>
                                      <span class="text-main text-semibold">
                                        <?php
                                          ...
                                          $job=$_GET['job'];
                                          echo "<a href=\"../../../dataStorage/1/$job/IncrementalPCA_$job.csv\">";
                                          echo "dataResponse</a>";
